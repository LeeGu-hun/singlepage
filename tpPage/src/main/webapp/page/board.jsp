...
<script src="<%=request.getContextPath()%>/js/board.js?ver=142333323"></script>

<div>
	<ul id="bTab" class="nav nav-tabs" role="tablist">
		<li id="pbli" role="presentation" class="active"><a href="#pageboard"
			aria-controls="pageboard" role="tab" data-toggle="tab"><label>주인글</label></a></li>
		<li id="mbli" role="presentation"><a href="#memberboard"
			aria-controls="memberboard" role="tab" data-toggle="tab"><label>방명록</label></a></li>
	</ul>
